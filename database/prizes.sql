...
update prize_schedule ps, prizes p set ps.win_date='2010-09-25 08:13:53' where ps.prize_id=p.id and p.image='WaterBall';

update prize_schedule ps, prizes p set ps.win_date='2010-10-02 02:13:05' where ps.prize_id=p.id and p.image='iPad';

update prize_schedule ps, prizes p set ps.win_date='2010-10-07 15:58:01' where ps.prize_id=p.id and p.image='Bose';

update prize_schedule ps, prizes p set ps.win_date='2010-10-15 21:06:22' where ps.prize_id=p.id and p.image='iPhone';

update prize_schedule ps, prizes p set ps.win_date='2010-10-24 05:40:48' where ps.prize_id=p.id and p.image='Travel';

update prize_schedule ps, prizes p set ps.win_date='2010-10-28 21:22:23' where ps.prize_id=p.id and p.image='HotTub';

update prize_schedule ps, prizes p set ps.win_date='2010-11-07 05:34:31' where ps.prize_id=p.id and p.image='TV';
