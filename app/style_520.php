...
/* =================================
			CONTAINER
==================================== */
#container2 { background:#000 url(<?= $web_url ?>/images/bg.jpg) repeat-y; margin:0 auto; padding-bottom:24px; position:relative; width:520px; color:#fff; font:13px/18px Tahoma;}
h1 a { background:url(<?= $web_url ?>/images/logo.png) no-repeat; display:block; height:36px; margin-left:18px; text-indent:-9999px; width:211px; } /* Background image changed */
#container2 .round { background:url(<?= $web_url ?>/images/play-n-win2.png) no-repeat; display:block; height:63px; margin:10px 20px 0 0; text-indent:-9999px; width:63px;} /* Added */
/* =================================
				MAIN CONTENT
==================================== */
#container2 #mainContent { background:#000; margin:0 auto; position:relative; width:480px;} /* Added */
#container2 h2 { background:url(<?= $web_url ?>/images/bot-or-not-2.jpg) no-repeat; display:block; height:54px; margin:15px 0 0 0px; text-indent:-9999px; width:370px; } /* Added */
#container2 #mainContent a.playBtn {background:url(<?= $web_url ?>/images/play-btn2.png) no-repeat; bottom:550px; height:100px; position:absolute; right:100px; text-indent:-9999px; width:230px; top: 365px} /* Added */
...
#container2 #mainContent p {font: 13px/18px tahoma; margin:23px auto 0 23px; width:415px;}
...
/* =================================
				TOP
==================================== */
#top { background:#1a1861; height:32px; margin:0 0 15px 0; font-family: "Helvetica Condensed", Arial, Helvetica, Sans-Serif; }
...
#btm { background:url(<?= $web_url ?>/<?= $web_url ?>/images/footer-bg2.png) repeat-y right; height:8px; margin:8px 0 0 0; }
...
.popup a { background:url(<?= $web_url ?>/<?= $web_url ?>/images/close.png) no-repeat; display:block; height:26px; margin:17px 0 0 0; text-indent:-9999px; width:49px; }
.popupInvite a { background:url(<?= $web_url ?>/<?= $web_url ?>/images/send.jpg) no-repeat; clear:both; display:block; height:21px; margin:0 7px 0 0; text-indent:-9999px; width:45px; }
