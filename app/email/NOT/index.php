	...
	<tr>
        ...
        <table width="700" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    ...
		    <th width="62%" scope="col" style="color:#fff; text-align:left; font-size: 14px; font-family: Tahoma, Geneva, sans-serif;font-weight: normal;"><p>You seem to be a connoisseur of the NOT BOT things in life. <br />
